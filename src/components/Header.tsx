...
const Header = () => {
  ...
  return (
    <div className=''>
      ...
      <div className={` z-10 absolute bg-white w-full  overflow-y-hidden  text-center transition-all duration-500 ${!menuOpen ? 'h-0  overflow-hidden transition-all duration-500' :  ' h-menuHeight overflow-auto pt-6'} `}>
