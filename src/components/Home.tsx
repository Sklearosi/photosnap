    ...
    return(
        <div>
            <div className="md:grid md:grid-cols-3 md:h-tabletHeight">
                <div style={{backgroundImage: `url(/assets/home/${media}/create-and-share.jpg)` }} className=" h-heroHeight bg-cover bg-center md:order-2 md:h-auto"></div>
                <div className=" bg-black w-full h-blackDiv  md:order-1 md:col-span-2 md:h-auto">
                    <div className=" md:w-11/12 m-auto md:mt-20">
                    <h1 className="text-4xl font-bold leading-2 tracking-widest text-white uppercase pt-16 ml-6 md:text-5xl">Create and share your photo stories.  </h1>
            ...
            <div className=" md:h-forHomeStories md:grid md:grid-cols-3">
                <div style={{backgroundImage: `url(/assets/home/${media}/beautiful-stories.jpg)`}} className=" bg-cover bg-center h-72 md:h-auto"></div>
                <div className="  w-full h-blackDiv md:col-span-2">
                    <div className=" md:w-11/12 m-auto pt-20">
                    <h1 className="text-4xl font-bold leading-2 tracking-widest text-black uppercase pt-16 ml-6 md:text-6xl">Beautiful Stories every time</h1>
            ...
            <div className="md:h-forHomeStories md:grid md:grid-cols-3">
                <div style={{backgroundImage: `url(/assets/home/${media}/designed-for-everyone.jpg)`}} className=" bg-cover bg-center h-72 md:h-full md:order-2"></div>
                <div className="  w-full h-blackDiv md:col-span-2">
                    <div className="md:w-11/12 m-auto pt-20">
                    <h1 className="text-4xl md:text-6xl font-bold leading-2 tracking-widest text-black uppercase pt-16 ml-6">DESIGNED FOR EVERYONE</h1>
