  ...
  return (
    <div>
      <div className="md:grid md:grid-cols-3 md:h-tabletHeight">
        <div
          style={{
            backgroundImage: `url(/assets/home/${media}/create-and-share.jpg)`,
          }}
          className=" h-heroHeight bg-cover bg-center md:order-2 md:h-auto lg:col-span-2"
        ></div>
        <div className=" bg-black w-full h-blackDiv  md:order-1 md:col-span-2 md:h-auto lg:col-span-1">
          <div className=" md:w-11/12 m-auto md:mt-20">
            <h1 className="text-4xl font-bold leading-2 tracking-widest text-white uppercase pt-16 ml-6 md:text-5xl lg:text-3xl">
              Create and share your photo stories.
            </h1>
            <p className="text-base font-normal leading-5 text-white mt-9 ml-6 w-11/12 lg:xs">
              Photosnap is a platform for photographers and visual storytellers.
              We make it easy to share photos, tell stories and connect with
              others.
            </p>
            <div className="flex w-40 justify-between items-center mt-10 ml-6 cursor-pointer group ">
              <p className="text-xs font-bold leading-4 tracking-wide text-white group-hover:underline">
                GET AN INVITE
              </p>
      ...
      <div className=" md:h-forHomeStories md:grid md:grid-cols-3">
        <div
          style={{
            backgroundImage: `url(/assets/home/${media}/beautiful-stories.jpg)`,
          }}
          className=" bg-cover bg-center h-72 md:h-auto lg:col-span-2"
        ></div>
        <div className="  w-full h-blackDiv md:col-span-2 lg:col-span-1">
          <div className=" md:w-11/12 m-auto pt-20">
            <h1 className="text-4xl font-bold leading-2 tracking-widest text-black uppercase pt-16 ml-6 md:text-6xl lg:text-3xl">
              Beautiful Stories every time
            </h1>
            <p className="text-base font-normal leading-5 text-black mt-9 ml-6 w-11/12">
              We provide design templates to ensure your stories look terrific.
              Easily add photos, text, embed maps and media from other networks.
              Then share your story with everyone.
            </p>
            <div className="flex w-40 justify-between items-center mt-10 ml-6 group cursor-pointer">
              <p className="text-xs font-bold leading-4 tracking-wide text-black group-hover:underline">
                VIEW THE STORIES
              </p>
              <svg xmlns="http://www.w3.org/2000/svg" width="43" height="14">
      ...
      <div className="md:h-forHomeStories md:grid md:grid-cols-3">
        <div
          ...
          className=" bg-cover bg-center h-72 md:h-full md:order-2 lg:col-span-2"
        ></div>
        <div className="  w-full h-blackDiv md:col-span-2 lg:col-span-1">
          <div className="md:w-11/12 m-auto pt-20">
            <h1 className="text-4xl md:text-6xl font-bold leading-2 tracking-widest text-black uppercase pt-16 ml-6 lg:text-3xl">
      ...
      <div className="m-auto mt-16 pb-20 w-9/12 grid gap-16 lg:grid-cols-3 lg:mt-20">
        ...
        <div className=" w-10/12 m-auto text-center grid gap-10 lg:mt-7">
          <img
            ...
            alt=""
          />
          <p className="text-xl font-bold leading-6 lg:mt-2">
