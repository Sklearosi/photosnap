  ...
  return (
    <div className="">
      <div className=" relative">
        <div
          style={{
            backgroundImage: `url(/assets/stories/${stories}/moon-of-appalacia.jpg)`,
          }}
          className=" h-heroHeight bg-cover bg-center md:h-tabletHeight"
        ></div>
        <div className=" bg-black w-full h-full pb-10 md:absolute md:z-10 md:top-0 md:bg-transparent md:pb-0 md:w-80 md:mt-24 md:left-12">
          <p className="text-xs font-bold leading-4 tracking-wide text-white ml-6 pt-10">
            LAST MONTH’S FEATURED STORY
          </p>
          <h1 className="text-4xl font-bold leading-2 tracking-widest text-white uppercase pt-8 ml-6">
            HAZY FULL MOON OF APPALACHIA
          </h1>
          <p className=" text-white ml-6 mt-5">
            March 2nd 2020 by John Appleseed
          </p>
          <p className="text-base font-normal leading-5 text-white mt-5 ml-6 w-11/12">
            The dissected plateau area, while not actually made up of geological
            mountains, is popularly called "mountains," especially in eastern
            Kentucky and West Virginia, and while the ridges are not high, the
            terrain is extremely rugged.
          </p>
          <div className="flex w-40 justify-between items-center mt-5 ml-6 group cursor-pointer">
      ...
      <div className=" text-white md:grid md:grid-cols-2 lg:grid-cols-4 relative">
        <div
          style={{
        ...
        >
          <div className=" absolute bottom-7 w-10/12 right-0 left-0 m-auto">
            <div className=" border-b border-white pb-3">
              <p className="text-[13px] font-normal leading-[17px] pb-1">
                April 16th 2020
              </p>
              <p>The Mountains</p>
