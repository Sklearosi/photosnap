...
const Footer = () => {
    return(
        <div className=" bg-black relative md:h-72">
            ...
            <div className=" flex w-40 justify-between m-auto mt-10 md:absolute md:mt-0 md:m-0 md:bottom-0">
            ...
            <div className=" flex items-center justify-between w-44 m-auto mt-20 md:absolute md:top-0 md:right-0 md:mt-0 md:m-0">
