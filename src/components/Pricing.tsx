    ...
    return (
        <div>
            ...
            <div className="md:grid md:grid-cols-3 md:h-featuresBegining">
                <div style={{backgroundImage: `url(/assets/pricing/${stories}/hero.jpg)`}} className=" h-heroHeight bg-cover bg-center md:order-2 md:h-auto lg:col-span-2"></div>
                ...
                <div className=" md:w-10/12 m-auto md:mt-20">
                    <h1 className="text-4xl font-bold leading-2 tracking-widest text-white uppercase pt-16 ml-6 md:text-6xl lg:text-3xl">PRICING</h1>
            ...
            <div className=' flex w-64 justify-between items-center m-auto mt-12 lg:pb-10'>
                <p>Monthly</p>
                <label htmlFor="pricing" className={` cursor-pointer block rounded-3xl w-16 h-7 bg-lightGray relative`}>
            ...
            <div className='w-11/12 m-auto mt-12 grid gap-10 lg:grid-cols-3 lg:pb-10'>
                <div className={` bg-lightGray  text-black text-center pb-14 pt-7 md:h-heroHeight md:pb-0 md:pt-0 md:relative  lg:h-[407px]`}>
                    <div className=' md:relative md:top-6   md:w-11/12 md:m-auto lg:static'>
                <div className=' w-10/12 m-auto md:text-left md:w-64 md:left-0 md:m-0 lg:text-center lg:w-full lg:mt-10'>
                ...
                <div className={` bg-black  text-white text-center pb-14 pt-7 md:h-heroHeight md:pb-0 md:pt-0 md:relative  lg:h-[470px] lg:-mt-5`}>
                    <div className=' md:relative md:top-6   md:w-11/12 md:m-auto lg:static'>
                <div className=' w-10/12 m-auto md:text-left md:w-64 md:left-0 md:m-0 lg:text-center lg:w-full lg:mt-10'>
                    <p className='pt-10 text-2xl font-bold leading-6'>Basic</p>
                    <p className='mt-5 text-base font-normal leading-5'>Includes basic usage of our platform. Recommended for new and aspiring photographers.</p>
            ...
            <div className=' w-11/12 m-auto mt-10 pb-14 lg:w-7/12'>
